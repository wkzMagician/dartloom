...
String windowsInstaller({String appName = 'Dartloom App'}) {
        ...
        run: |
          ...
          case "\${{ matrix.platform }}" in
            ...
            macos)
              ...
              ;;
            windows)
              powershell -NoProfile -Command '& "C:\\Program Files (x86)\\Inno Setup 6\\ISCC.exe" "/DMyAppVersion=\${{ inputs.git_ref }}" installer\\windows.iss'
              ;;
            linux)
...
''',
    TargetPlatform.windows => '''      - name: Package Windows installer
        ...
        run: |
          ...
          & "C:\\Program Files (x86)\\Inno Setup 6\\ISCC.exe" "/DMyAppVersion=\${{ github.ref_name }}" installer\\windows.iss
''',
